  ...
  const ContactCard = React.memo(({ data }) => {
    ...
    return (
      <a
        ...
        className="group flex flex-col justify-center items-center text-center p-6 rounded-2xl bg-black hover:bg-black/80 transition-all duration-300 shadow-xl hover:shadow-lime-400/30 border border-lime-500/20 hover:border-lime-400"
      >
        <div className="text-3xl text-lime-400 mb-2 group-hover:scale-110 transition-transform">
          {IconComponent && <IconComponent />}
        </div>
        <p className="text-sm text-lime-300">{label}</p>
        <p className="text-white text-md font-semibold group-hover:text-lime-400 break-words mt-1">
          {text}
        </p>
      </a>
    )
    ...
    <section className="text-white pb-20 pt-32 px-6 min-h-screen flex items-center justify-center bg-black">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="p-8 sm:p-10 rounded-2xl bg-black border border-lime-400/30 shadow-2xl hover:shadow-lime-500/20 transition-all duration-300">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-semibold text-lime-300 mb-2">
              Availability
            </h2>
          ...
          <button className="w-full max-w-fit px-6 py-3 bg-lime-400 text-black font-bold rounded-full hover:bg-lime-500 shadow-md hover:shadow-lime-400 transition-transform hover:scale-105 flex gap-2 items-center">
